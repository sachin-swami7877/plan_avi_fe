        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5">
            ...
            <button
              ...
              className="group relative rounded-2xl overflow-hidden bg-[#075e54] shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.04] active:scale-[0.97]"
            >
              <div className="aspect-square relative overflow-hidden flex items-center justify-center">
                <svg className="w-24 h-24 sm:w-32 sm:h-32 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="pb-3 sm:pb-4 text-center bg-gradient-to-t from-black/40 to-transparent -mt-4 pt-6">
                <p className="font-bold text-white text-sm sm:text-base drop-shadow">Support</p>
                <p className="text-white/70 text-[10px] sm:text-xs mt-0.5">Chat on WhatsApp</p>
              </div>
            </button>
          </div>
          {/* Share & Copy buttons */}
