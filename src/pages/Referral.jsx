    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-md mx-auto px-4 pt-4 pb-28">
        ...
        {loading ? (
          ...
          <>
            {/* Referral Code Card */}
            <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-3 mb-3 text-white shadow-lg">
              <p className="text-primary-200 text-[10px] font-medium mb-0.5">YOUR CODE</p>
              <div className="flex items-center justify-between gap-2">
                <span className="text-xl font-black tracking-widest">{data?.referralCode || '—'}</span>
                <button
                  onClick={handleCopy}
                  className="flex items-center gap-1 px-3 py-1.5 bg-white/20 rounded-lg text-xs font-semibold active:scale-95 transition-transform"
                >
                  {copied ? (
