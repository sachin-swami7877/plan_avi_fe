                ...
                <div className="px-4 pb-4 border-t border-gray-100 pt-3">
                  ...
                  {user.referralCode && (
                    <div className="flex items-center gap-2 mb-1">
                      <p className="text-xs text-gray-500">Referral Code: <span className="font-mono font-bold text-primary-600 tracking-widest">{user.referralCode}</span></p>
                      <button onClick={() => { navigator.clipboard.writeText(user.referralCode); toast.success('Referral code copied'); }} className="p-0.5 rounded hover:bg-gray-100" title="Copy">
